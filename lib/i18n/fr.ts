...
export const fr = {
  ...
  espace: {
    ...
    apprenantTitre: 'Apprenant',
    apprenantTexte: 'Rejoindre mon parcours',
    cockpitTitre: 'Le Cockpit',
    cockpitTexte: 'Administrateurs et formateurs',
    cockpitBouton: 'Se connecter au Cockpit',
    personnel: 'Vous faites partie de l’équipe ?',
    personnelLien: 'Entrée du Cockpit',
    enAttenteAccroche: 'Bien reçu !',
    enAttenteTitre: 'Votre candidature est enregistrée',
    enAttenteTexte:
      'La Fondation étudie les candidatures et sélectionne les participants. Nous vous contacterons par e-mail, ou par téléphone si vous l’avez indiqué, dès que vous serez sélectionné. Votre espace s’ouvrira alors ici, avec ce même compte Google.',
    enAttenteMerci: 'Merci pour votre candidature. Vous n’avez rien d’autre à faire pour l’instant.',
    inscritLe: 'Candidature reçue le',
    googleErreur: 'La connexion avec Google n’a pas abouti. Réessayez, en choisissant bien le compte que vous voulez utiliser.',
    googleRefuse: 'Google n’a pas autorisé la connexion avec ce compte. Vérifiez que l’adresse est bien vérifiée, ou essayez un autre compte.',
  ...
  admin: {
    ...
    utilisateurs: {
      ...
      ville: 'Ville',
      villeAide: 'Brazzaville ou Pointe-Noire',
      villeInconnue: '— Non renseignée —',
  ...
  vitrine: {
    ...
    iaLab: {
      ...
      explorer: 'Explorer',
      photoPourquoi: 'Une pile de CV à traiter à côté d’un ordinateur qui les analyse.',
      photoApproche: 'Un intervenant présente l’intégration de l’IA dans les processus à une équipe réunie autour d’une table.',
      photoIntervention: 'Un développeur devant trois écrans, dont l’un affiche ia.lab.',
